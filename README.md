...
survives a regeneration in **200/200 of the example drawings**, whatever their shape.

## What it looks like

200 example drawings, all generated from the YAML sources in
...
- A validator (78 checks) that explains, in the writer's terms, what will not be drawn —
