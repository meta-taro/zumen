...
survives a regeneration in **109/109 of the example drawings**, whatever their shape.

## What it looks like

109 example drawings, all generated from the YAML sources in
...
- A validator (60 checks) that explains, in the writer's terms, what will not be drawn —
