...
survives a regeneration in **167/167 of the example drawings**, whatever their shape.

## What it looks like

167 example drawings, all generated from the YAML sources in
...
- A validator (75 checks) that explains, in the writer's terms, what will not be drawn —
