...
survives a regeneration in **119/119 of the example drawings**, whatever their shape.

## What it looks like

119 example drawings, all generated from the YAML sources in
...
- A validator (63 checks) that explains, in the writer's terms, what will not be drawn —
