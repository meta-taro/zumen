...
survives a regeneration in **141/141 of the example drawings**, whatever their shape.

## What it looks like

141 example drawings, all generated from the YAML sources in
...
- A validator (74 checks) that explains, in the writer's terms, what will not be drawn —
