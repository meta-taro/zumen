...
survives a regeneration in **201/201 of the example drawings**, whatever their shape.

## What it looks like

201 example drawings, all generated from the YAML sources in
...
- A validator (79 checks) that explains, in the writer's terms, what will not be drawn —
