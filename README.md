...
survives a regeneration in **191/191 of the example drawings**, whatever their shape.

## What it looks like

191 example drawings, all generated from the YAML sources in
...
- A validator (77 checks) that explains, in the writer's terms, what will not be drawn —
